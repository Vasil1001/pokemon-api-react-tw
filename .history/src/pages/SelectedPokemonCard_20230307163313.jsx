...
export default function SelectedPokemonCard() {
  ...
  return (
    <div className="min-w-screen min-h-screen h-screen-vh mx-auto p-5 text-gray-100">
      ...
      <p style = {{ fontFamily: 'Pokemon-Hollow'}} className="text-yellow-400 text-5xl mb-5">Pokemon</p>
      <p style = {{ fontFamily: 'Pokemon-Solid'}} className=" text-8xl mb-16">{selectedPokemon.name}</p>
