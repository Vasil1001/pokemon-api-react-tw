      ...
      {selectedPokemon.id && (
        <div>
          ...
          <div className="grid grid-cols-6 gap-6 text-slate-800">
            ...
            <div className="flex flex-col items-center font-bold text-xl text-slate-800 gap-4 col-span-6 sm:col-span-6 md:col-span-4 lg:col-span-4 xl:col-span-4 px-7 py-3 bg-green-400 rounded-lg">
              Stats
              ...
              <div className="flex text-base gap-2 justify-evenly">
