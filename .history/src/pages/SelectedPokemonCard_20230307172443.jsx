      ...
      {selectedPokemon.id && (
        <div>
          ...
          <div className="grid grid-cols-6 gap-6">
            ...
            <div className="flex flex-col font-bold text-slate-700 gap-4 col-span-6 sm:col-span-6 md:col-span-4 lg:col-span-4 xl:col-span-4 p-10 bg-green-400 rounded-lg">
