...
export default function PokemonList() {
  ...
  return (
    <div className="mx-auto xl:w-10/12 lg:w-10/12 md:w-12/12"> 
      <Searchbar />
      <div className=" grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-7 px-5 bg-slate-800">
