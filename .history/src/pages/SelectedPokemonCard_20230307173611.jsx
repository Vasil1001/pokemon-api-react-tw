    ...
    <div className="min-w-screen min-h-screen h-screen-vh mx-auto p-5 lg:w-10/12 md:w-12/12 xl:w-8/12 sm:w-12/12 ">
      ...
      {selectedPokemon.id && (
        <div>
          ...
          <div className="grid grid-cols-6 gap-4 text-slate-800">
            ...
            <div className="flex flex-col font-bold text-xl text-slate-800 gap-3 col-span-6 sm:col-span-6 md:col-span-4 lg:col-span-4 xl:col-span-4 px-7 py-3 bg-green-400 rounded-lg">
              Stats
