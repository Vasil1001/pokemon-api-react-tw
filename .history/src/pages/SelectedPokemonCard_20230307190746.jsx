            ...
            <div className="flex flex-col bg-slate-300 px-7 py-3 col-span-3 p-10 rounded-lg">
              ...
              <div className="flex gap-5">
                <div className="flex flex-col">
                  ...
                  <p className="p-3 font-bold border border-1 border-slate-500 shadow-lg rounded-lg bg-slate-400">
                ...
                <div className="flex">
                  <div className="flex flex-col">
                    <p className="font-bold mb-1">Type</p>
                    <p className="p-3 font-bold border border-1 border-slate-500 shadow-lg rounded-lg bg-slate-300">
                      {selectedPokemon.types[0].type.name}
                    </p>
                  </div>
                </div>
