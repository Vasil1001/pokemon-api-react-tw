      ...
      {selectedPokemon.id && (
        <div>
          ...
          <div className="grid grid-cols-6 gap-3 text-slate-800">
            <div className="flex flex-col  items-center justify-between col-span-6 sm:col-span-6 md:col-span-2 lg:col-span-2 xl:col-span-2 px-7 py-3 bg-slate-300 rounded-lg">
            ...
            <div className="flex bg-slate-300 px-7 py-3 col-span-3 p-10 rounded-lg">
              Details
            </div>
            <div className="flex bg-slate-300 px-7 py-3 col-span-3 p-10 rounded-lg">
              Evolution
