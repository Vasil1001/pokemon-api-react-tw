        ...
        <div>
          ...
          <div className="grid grid-cols-6 gap-3 text-slate-800">
            ...
            <div className="flex flex-col bg-slate-300 px-7 py-3 col-span-3 p-10 rounded-lg">
              ...
              <div className="flex gap-3">
                {selectedPokemon.types
                  ? selectedPokemon.types.map((type, index) => (
                      <div>
                        <p className="p-2 px-3 font-bold  ring-2 ring-slate-700 shadow-lg rounded-lg bg-yellow-300">
              ...
              <p className="font-bold mb-1 mt-5">Weaknesses</p>
              <div className="flex gap-3">
                {typeDetails
                  ? typeDetails.damage_relations.half_damage_to.map(
                      (type, index) => (
                        <div>
                          <p className="p-2 font-bold text-sm ring-2 ring-slate-700 shadow-lg rounded-lg bg-red-400">
                            {type.name}
                          </p>
                        </div>
                      )
