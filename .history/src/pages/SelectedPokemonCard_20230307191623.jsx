            ...
            <div className="flex flex-col bg-slate-300 px-7 py-3 col-span-3 p-10 rounded-lg">
              ...
              <div className="flex gap-5">
                <div className="flex flex-col">
                  ...
                  {selectedPokemon.types && selectedPokemon.types.map((pokemon, index) => (
                    <div><p className="p-3 font-bold border border-1 border-slate-500 shadow-lg rounded-lg bg-blue-300">
