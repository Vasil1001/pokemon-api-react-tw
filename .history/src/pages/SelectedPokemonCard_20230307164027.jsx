  ...
  return (
    <div className="min-w-screen min-h-screen h-screen-vh mx-auto p-5 lg:w-10/12 md:w-12/12 xl:w-8/12 sm:w-12/12 text-gray-100">
      ...
      <div className="grid grid-cols-6 gap-6">
        <div className="flex col-span-6 sm:col-span-6 md:col-span-2 lg:col-span-2 xl:col-span-2 p-10 bg-green-500 rounded-lg">
        <img src={selectedPokemon.sprites.front_default} alt="pokemon" /></div>
