      ...
      {selectedPokemon.id && (
        <div>
          ...
          <div className="grid grid-cols-6 gap-3 text-slate-800">
            ...
            <div className="flex bg-slate-300 px-7 py-3 col-span-3 p-10 bg-green-500 rounded-lg">
              Details
            </div>
            <div className="flex bg-slate-300 px-7 py-3 col-span-3 p-10 bg-green-400 rounded-lg">
              Evolution
            </div>
          </div>
        </div>
