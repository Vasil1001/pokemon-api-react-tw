  ...
  return (
    <div className="min-w-screen min-h-screen h-screen-vh mx-auto p-5 text-gray-100">
      <div className="grid grid-cols-6 gap-7">
        <div className="flex col-span-2 p-10 bg-green-500 rounded-lg">
            a
        </div>
        <div className="flex col-span-4 p-10 bg-green-400">
          a
        </div>

        <div className="flex col-span-3 p-10 bg-green-500">
            a
        </div>
